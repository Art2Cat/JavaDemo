...
public class JdbcSpitterRepository implements SpitterRepository {
    ...
    /**
     * Inserts a spitter using SimpleJdbcInsert. Involves no direct SQL and is able to return the ID
     * of the newly created Spitter.
     *
    ...
    /**
     * Inserts a spitter using a simple JdbcTemplate update() call. Does not return the ID of the
     * newly created Spitter.
     *
