...
public class ReflectTest {
     ...
     * getDeclaredField/Method to get private field or method, getField/Method to get public field
     * or method.
     */
    @Test
    ...
    public void testVehicleProxy() {
        ...
        IVehicle proxy = (IVehicle) Proxy
            .newProxyInstance(car.getClass().getClassLoader(), car.getClass().getInterfaces(),
                vehicleProxy);
